...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) throws EstacionamentoException, NullPointerException{
        
        
        if(placa.isEmpty() || placa == null) throw new NullPointerException();
        if(cor == null) throw new NullPointerException();
        if(motorista == null) throw new EstacionamentoException("Sem motorista");
